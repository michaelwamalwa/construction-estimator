...
// Assuming your image imports work correctly, otherwise consider using `import` instead of `require`
          ...
          <div className="container px-4 px-lg-5 mt-5">
            <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
              {products.map((product, index) => (
                <div className="col mb-5" key={index}></div>
              ))}
          ...
          {cartItems.length === 0 ? (
            ...
            <div className="cart-items">
              ...
              <div className="cart-total">
                ...
                <button onClick={navigateToCart}>Proceed to Checkout</button>
              </div>
            </div>
          )}
        </section>
