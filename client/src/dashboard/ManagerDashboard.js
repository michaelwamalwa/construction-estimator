      ...
      <div className="sidebar">
        <ul className="sidebar-nav">
          ...
          <li>
            <Link
              className={
                selectedTab === "resource-management"
                  ? "nav-link active"
                  : "nav-link"
              }
          ...
          <li>
            <Link
              className={
                selectedTab === "task-workflow-management"
                  ? "nav-link active"
                  : "nav-link"
              }
          ...
          <li>
            <Link
              className={
                selectedTab === "communication-collaboration"
                  ? "nav-link active"
                  : "nav-link"
              }
          ...
          <li>
            <Link
              className={
                selectedTab === "document-management"
                  ? "nav-link active"
                  : "nav-link"
              }
